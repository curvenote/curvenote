...
export const loader = async (args: Route.LoaderArgs) => {
  ...
  const clientSideConfig: ClientDeploymentConfig = strictObject<ClientDeploymentConfig>({
    ...
    webVersionPreviewUrl: ctx.$config.app?.webVersionPreviewUrl,
    ...
    dashboard: {
      welcome: ctx.$config.app?.dashboard?.welcome,
      tasks: ctx.$config.app?.dashboard?.tasks,
    },
    statusBar: {
      reportProblem: {
  ...
  validateKeys<ClientDeploymentConfig>(clientSideConfig, [
    ...
    'dashboard.welcome.showTasks',
    'dashboard.welcome.videos',
    'dashboard.welcome.videos.*.title',
    'dashboard.welcome.videos.*.url',
