...
Any packages added to the extensions folder will be treated as external workspace packages. Install and build from the monorepo root with Bun (`bun install`, `bun run build`).