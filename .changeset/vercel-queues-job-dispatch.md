...
Replace Pub/Sub job dispatch with a Vercel Queues pipeline: enqueue via `@vercel/queue`, consume through `api/v1.jobs.vercel-push`, and retire the Pub/Sub emulator tooling and dispatch routes.
