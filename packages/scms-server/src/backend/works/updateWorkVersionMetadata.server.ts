...
import type { AuthorFieldMetadata, MystFrontmatterWithAuthors } from '@curvenote/scms-core';
import { authorFieldToMystFrontmatter, deriveWorkVersionAuthors } from '@curvenote/scms-core';
