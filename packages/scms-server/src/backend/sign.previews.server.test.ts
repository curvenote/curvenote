...
describe('work version preview tokens', () => {
  ...
  const audience = 'scms-work-preview';
  const workVersionId = '11111111-1111-1111-1111-111111111111';

  it('mints a token with work_version scope and the given audience', () => {
    const token = createWorkVersionPreviewToken(workVersionId, issuer, key, audience);
