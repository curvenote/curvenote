...
const SITE_ROLES: Record<SiteRole, Set<string>> = {
  [SiteRole.ADMIN]: new Set([
    ...
    site.users.delete,
    site.users.admin,
    site.serviceAccount.list,
    site.serviceAccount.read,
    site.serviceAccount.create,
    site.serviceAccount.delete,
  ...
  [SiteRole.FEED]: new Set([site.history]),
  [SiteRole.PUBLIC]: new Set([site.read, site.history]),
