...
export enum SlackEventType {
  ...
  SITE_SERVICE_ACCOUNT_CREATED = 'SITE_SERVICE_ACCOUNT_CREATED',
  SITE_SERVICE_ACCOUNT_DELETED = 'SITE_SERVICE_ACCOUNT_DELETED',
  SITE_SERVICE_ACCOUNT_TOKEN_CREATED = 'SITE_SERVICE_ACCOUNT_TOKEN_CREATED',
  SITE_SERVICE_ACCOUNT_TOKEN_DELETED = 'SITE_SERVICE_ACCOUNT_TOKEN_DELETED',
  INBOUND_EMAIL_RECEIVED = 'INBOUND_EMAIL_RECEIVED',
  CHECK_RUN_STARTED = 'CHECK_RUN_STARTED',
  CHECK_RUN_MILESTONE = 'CHECK_RUN_MILESTONE',
  CHECK_RUN_ERROR = 'CHECK_RUN_ERROR',
  CHECK_RUN_RETRY = 'CHECK_RUN_RETRY',
  CHECK_EULA_ACCEPTED = 'CHECK_EULA_ACCEPTED',
}
