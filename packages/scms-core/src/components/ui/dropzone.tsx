...
export const DropzoneContent = ({ children, className }: DropzoneContentProps) => {
  ...
  return (
    <div className={cn('flex flex-col items-center justify-center', className)}>
      <div className="flex items-center justify-center rounded-md size-8 bg-muted text-muted-foreground">
        <UploadIcon size={16} />
      </div>
      <p className="w-full my-2 text-sm font-medium truncate">
...
export const DropzoneEmptyState = ({ children, className }: DropzoneEmptyStateProps) => {
  ...
  return (
    <div className={cn('flex flex-col items-center justify-center', className)}>
      ...
      <p className="w-full my-2 text-sm font-medium truncate text-wrap">
