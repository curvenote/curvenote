...
import { DocumentPreviewCard } from './DocumentPreviewCard.js';
import { MetadataFormCard } from './MetadataFormCard.js';
import type { DocumentPreviewItem } from '../../utils/documentPreviewTypes.js';
import type { ExtractedMetadata } from '../../utils/extractedMetadata.js';
import type { AuthorFieldMetadata } from '../authors/mystAuthorAdapters.js';
import { stepAutoExtractOnPreviewChange } from './autoExtractOnPreviewChange.js';
import {
  computeMetadataExtractBusyFlags,
  stepPreviewCandidateCountChange,
} from './previewCandidateFileCount.js';
...
export function MetadataExtractSection({
  ...
  const extractMetadataFetcher = useFetcher<{ error?: { message?: string } }>();
  const clearMetadataFetcher = useFetcher<{ error?: { message?: string } }>();
