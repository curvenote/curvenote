...
export const SiteInvitationEmail = ({
  asBaseUrl,
  branding,
  unsubscribeUrl,
  siteName,
  ...
  inviterEmail,
  recipientName,
}: SiteInvitationEmailProps & DefaultEmailProps) => {
  const previewText = `You've been invited to join ${siteName} as ${role}`;
        ...
        <Body className="px-2 mx-auto my-auto font-sans bg-white">
          <Container className="mx-auto my-[40px] max-w-[465px] rounded border border-[#eaeaea] border-solid p-[20px]">
            ...
            <Text className="text-[14px] text-black leading-[24px]">
              ...
              <strong>{siteName}</strong> as <strong>{role}</strong>.
            </Text>
            <Text className="text-[14px] text-black leading-[24px]">
              Click the button below to access the site and start collaborating:
            </Text>
...
export default SiteInvitationEmail;
